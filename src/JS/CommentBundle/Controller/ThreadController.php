...
class ThreadController extends Controller
{
    ...
    public function newThreadsAction()
    {
        ...
        $view = View::create()
            ...
            ->setTemplate('@JSComment/Thread/new.html.twig');
    ...
    public function editThreadCommentableAction(Request $request, $id)
    {
        ...
        $view = View::create()
            ...
            ->setTemplate('@JSComment/Thread/commentable.html.twig');
    ...
    public function newThreadCommentsAction(Request $request, $id)
    {
        ...
        $view = View::create()
            ...
            ->setTemplate('@JSMeme/Thread/comment_new.html.twig');
    ...
    public function getThreadCommentAction($id, $commentId)
    {
        ...
        $view = View::create()
            ...
            ->setTemplate('@JSComment/Thread/comment.html.twig');
    ...
    public function removeThreadCommentAction(Request $request, $id, $commentId)
    {
        ...
        $view = View::create()
            ...
            ->setTemplate('@JSComment/Thread/comment_remove.html.twig');
    ...
    public function editThreadCommentAction($id, $commentId)
    {
        ...
        $view = View::create()
            ...
            ->setTemplate('@JSComment/Thread/comment_edit.html.twig');
    ...
    public function getThreadCommentsAction(Request $request, $id)
    {
        ...
        if (null === $thread) {
            ...
            if (count($errors) > 0) {
                $view = View::create()
                    ...
                    ->setTemplate('@JSComment/Thread/errors.html.twig');
        ...
        $view = View::create()
            ...
            ->setTemplate('@JSComment/Thread/comments.html.twig');

        // Register a special handler for RSS. Only available on this route.
        if ('rss' === $request->getRequestFormat()) {
            $templatingHandler = function ($handler, $view, $request) {
                $view->setTemplate('@JSComment/Thread/thread_xml_feed.html.twig');
    ...
    public function getThreadCommentVotesAction($id, $commentId)
    {
        ...
        $view = View::create()
            ...
            ->setTemplate('@JSComment/Thread/comment_votes.html.twig');
    ...
    public function newThreadCommentVotesAction(Request $request, $id, $commentId)
    {
        ...
        $view = View::create()
            ...
            ->setTemplate('@JSComment/Thread/vote_new.html.twig');
    ...
    protected function onCreateCommentError(FormInterface $form, $id, CommentInterface $parent = null)
    {
        $view = View::create()
            ...
            ->setTemplate('@JSComment/Thread/comment_new.html.twig');
